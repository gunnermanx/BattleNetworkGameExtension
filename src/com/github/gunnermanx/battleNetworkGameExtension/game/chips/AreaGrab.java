...
public class AreaGrab extends Chip {

	public AreaGrab(BattleNetworkGame game, Player player, JSONObject chipJSON, int x, int y) {
...
//		this.game.damageUnit(target, damage);
		...
		int x = game.getFirstXWithEnemyTile(player.owner, this.playerX, this.playerY);
		game.setColumnTileOwnership(player.owner, x);
	}
